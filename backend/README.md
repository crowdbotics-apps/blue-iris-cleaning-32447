...
## Project Structure
    ...
    ├── blue_iris_cleaning_32447  # Django project configurations
...
1. Clone this repo and `cd blue_iris_cleaning_32447`
...
2. Clone this repo and `cd blue_iris_cleaning_32447`
